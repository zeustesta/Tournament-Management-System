...
public class Torneo_PingPong extends Torneo{

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    // ATRIBUTOS
        private ArrayList<Partido_PingPong> Partidos;

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    // CONSTRUCTORES
        public Torneo_PingPong(String nombre, ArrayList<Equipo_PingPong> equipos, ListaDeDatos<Arbitro> Arbitros) {
            super(nombre);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // METODOS
        ...
        // SORTEAR EQUIPOS
            public void SortearPartidos(ArrayList<Equipo_PingPong>equipos, ArrayList<Partido_PingPong>partidos, ListaDeDatos<Arbitro> arbitros) {
                ...
                for (int i=0 ; i<16 ; i=i+2){
                    ...
                    arbitroSelected=rand.nextInt(arbitros.size());
                    Partido_PingPong NuevoPartido = new Partido_PingPong(equipos.get(i), equipos.get(i+1), arbitros.get(arbitroSelected), 0);
        ...
        // SELECCIONAR PARTIDO
                                ...
                                if (!Partidos.get(Index).isActivo()) { // SI EL PARTIDO FINALIZO
                                    ...
                                    if (Partidos.get(Index).getNro_Ronda() == 3) { // SI FUE LA FINAL
                                        ...
                                        if (!Partidos.get(Partidos.size() - 1).EstaElPartidoCompleto()) {
                                            ...
                                            Partido_PingPong Nuevo = new Partido_PingPong(Partidos.get(Index).getNro_Ronda() + 1, Partidos.get(Index).getArbitro());
                                            if (Partidos.get(Index).isGanador()) {
            ...
            public void MostrarPartidosDisponibles(){
                ...
                for (Partido_PingPong Aux : Partidos){
            ...
            private void MostrarPartidoDisponible(Partido_PingPong Mostrar){
        ...
        // MOSTRAR PARTIDOS JUGADOS
            public void MostrarPartidosJugados(){
                ...
                System.out.print("\n |              |-|          |-|            |-|----Dni----|-|----Nombre----|-|----Apellido----|-|                           |-|----Nombre----|-|Sets|-|Puntos|-|Aces|-|Saques Errados|-|----Nombre----|-|Sets|-|Puntos|-|Aces|-|Saques Errados|");
                for (Partido_PingPong Aux : Partidos){
                    if (!Aux.isActivo()){
            ...
            public void MostrarPartidoJugado(Partido_PingPong Mostrar){
                System.out.printf("\n |%14s|", Mostrar.getId_Partido());
                System.out.printf("-|%10s|", Mostrar.EstaActivo());
                System.out.printf("-|%12s|", Mostrar.getNro_RondaString());
                System.out.printf("-|%11s|", Mostrar.getArbitro().getDni());
                ...
                System.out.printf("-|%6s|", Mostrar.getPuntosGanados_E1());
                System.out.printf("-|%4s|", Mostrar.getAces_E1());
                System.out.printf("-|%14s|", Mostrar.getSaquesErrados_E1());
                System.out.printf("-|%14s|", Mostrar.getEquipo_2().getJugador().getNombre());
                System.out.printf("-|%4s|", Mostrar.getSetsGanados_E2());
                System.out.printf("-|%6s|", Mostrar.getPuntosGanados_E2());
                System.out.printf("-|%4s|", Mostrar.getAces_E2());
                System.out.printf("-|%14s|", Mostrar.getSaquesErrados_E2());
            }
        ...
        // MOSTRAR EQUIPOS PARTICIPANTES
            public void MostrarEquiposParticipantes(){
                ...
                for (int i=0 ; i<8 ; i++){
                    Mostrar_Equipo_PingPong(Partidos.get(i).getEquipo_1());
                    Mostrar_Equipo_PingPong(Partidos.get(i).getEquipo_2());
                }
                System.out.print("\n ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
            }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // VERIFICADORES
        ...
        public boolean ExisteEquipo(Equipo_PingPong Aux){
            boolean Retornar = false;
            for(int i=0 ; i<4 ; i++){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // RETORNADORES GETTERS SETTERS
        ...
        public ArrayList<Partido_PingPong> getPartidos() {
            return Partidos;
        }
